...
<div style="display:none;" class="form-group row align-items-center"
    ...
    <label for="slug" class="col-form-label text-md-right"
        :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.slug') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.slug" v-validate="'required'" @input="validate($event)" class="form-control"
            ...
            id="slug" name="slug" placeholder="{{ trans('admin.post.columns.slug') }}">
        <div v-if="errors.has('slug')" class="form-control-feedback form-text" v-cloak>@{{ errors . first('slug') }}
        </div>
    </div>
</div>

<div class="form-group row align-items-center"
    :class="{'has-danger': errors.has('perex'), 'has-success': fields.perex && fields.perex.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.perex" v-validate="''" @input="validate($event)" class="form-control"
            :class="{'form-control-danger': errors.has('perex'), 'form-control-success': fields.perex && fields.perex.valid}"
            id="perex" name="perex" placeholder="{{ trans('admin.post.columns.perex') }}">
        <div v-if="errors.has('perex')" class="form-control-feedback form-text" v-cloak>@{{ errors . first('perex') }}
        </div>
    </div>
</div>
...
<div class="form-group row align-items-center"
    ...
    <label for="text" class="col-form-label text-md-right"
        :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.text') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <div>
            <wysiwyg v-model="form.text" v-validate="'required'" id="text" name="text" :config="mediaWysiwygConfig">
            </wysiwyg>
        </div>
        <div v-if="errors.has('text')" class="form-control-feedback form-text" v-cloak>@{{ errors . first('text') }}
        </div>
    </div>
</div>
...
<div class="form-check row"
    ...
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-10'">
        ...
        <div v-if="errors.has('enabled')" class="form-control-feedback form-text" v-cloak>
            @{{ errors . first('enabled') }}</div>
    </div>
</div>

<div class="form-group row align-items-center"
    :class="{'has-danger': errors.has('views'), 'has-success': fields.views && fields.views.valid }">
    <label for="views" class="col-form-label text-md-right"
        :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.post.columns.views') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.views" v-validate="'required|integer'" @input="validate($event)"
            class="form-control"
            :class="{'form-control-danger': errors.has('views'), 'form-control-success': fields.views && fields.views.valid}"
            id="views" name="views" placeholder="{{ trans('admin.post.columns.views') }}">
        <div v-if="errors.has('views')" class="form-control-feedback form-text" v-cloak>@{{ errors . first('views') }}
        </div>
    </div>
</div>
